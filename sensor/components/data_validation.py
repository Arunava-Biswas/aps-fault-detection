...
class DataValidation:
    ...
    # Function to drop all the columns with missing values which will not match the threshold criteria set in config_entity
    # This function will return another dataframe or it can return Null (for this we use Optional)
    # report_key_name is for each column we need to pass this parameter, also with the help of this we will do the logging
    ...
    # Function to compare the number of columns are same as the base dataset or not
    # Here we need to pass both base dataframe (base_df) and the present dataframe (current_df) with which we compare
    ...
    # Function to create data drift report
    def data_drift(self,base_df:pd.DataFrame,current_df:pd.DataFrame,report_key_name:str):
        try:
            ...
            for base_column in base_columns:
                ...
                # Comparing the distribution of column from both dataframes
            ...
            # writing the report for validation error
            self.validation_error[report_key_name]=drift_report
        except Exception as e:
            raise SensorException(e, sys)


    # Now creating the validation report
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            # Creating dataframes with converted data types
            # We don't want the 'TARGET_COLUMN' to be changed it's datatype
